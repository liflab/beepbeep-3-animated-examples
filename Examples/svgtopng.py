...
"""
Author: Alexandre Bourget (modified by Sylvain Hallé)
Copyright (c) 2008: Alexandre Bourget; 2019: Sylvain Hallé
LICENSE: GPLv3
...
layer name. The opacity must be between 0 and 1. Example:
    ...
    if options.imageexport:
        ...
        print "Exporting images as PNGs"
    else:
        # Join PDFs
        has_pyPdf = False
        try:
